...
Опубликованные сборки macOS подписываются и нотарифицируются. Локальные
неподписанные dev-сборки всё ещё могут требовать ручного снятия quarantine перед
запуском.
