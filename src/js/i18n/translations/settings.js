export const settingsTranslations = {
  "ru": {
    ...
    "settings.downloader.profile.segment.aria": "Выбор профиля качества загрузки",
    ...
    "settings.downloader.profile.summary.remember.hint": "Повторяет прошлый тип потока.",
    "settings.downloader.profile.summary.audio.title": "Только аудио",
    "settings.downloader.profile.summary.audio.hint": "Сразу показывает звуковые форматы.",
    ...
    "settings.downloader.parallel.hint": "2 быстрее, но выше нагрузка на систему.",
    ...
    "settings.downloader.layout.hint": "Основные параметры загрузки и поведения окна.",
    "settings.downloader.group.parallel": "Параллельность и запуск",
    "settings.downloader.group.behavior": "Поведение окна и завершения",
    "settings.downloader.tools.hint": "Проверка статуса и обновление зависимостей загрузчика.",
    ...
    "settings.tools.modal.subtitle": "Проверка статуса, переустановка и смена папки зависимостей.",
    "settings.disableTab": "Отключить вкладку",
    "settings.wg.title": "Вкладка «Tools»",
    "settings.wg.disable.hint": "Скрывает вкладку Tools и отключает её запуск. При отключении связанные параметры становятся недоступны.",
    ...
    "settings.wg.rememberLastTool.hint": "При следующем открытии вкладки Tools сразу показывает инструмент, который был открыт последним.",
    "settings.wg.autoclose.hint": "Автоматически закрывает приложение через выбранное время.",
    ...
    "settings.developer.hint": "Введите секретное слово, чтобы активировать скрытые функции.",
  ...
  "en": {
    ...
    "settings.downloader.profile.segment.aria": "Select download quality profile",
    ...
    "settings.downloader.profile.summary.remember.hint": "Reuses the previous stream type.",
    "settings.downloader.profile.summary.audio.title": "Audio only",
    "settings.downloader.profile.summary.audio.hint": "Opens audio formats immediately.",
    ...
    "settings.downloader.parallel.hint": "2 is faster, but uses more system resources.",
    "settings.downloader.parallel.option1": "1",
    "settings.downloader.parallel.option2": "2",
    ...
    "settings.downloader.layout.hint": "Core download options and window behavior settings.",
    ...
    "settings.downloader.tools.hint": "Check status and update downloader dependencies.",
    ...
    "settings.tools.modal.subtitle": "Check status, reinstall dependencies, and change the tools folder.",
    "settings.disableTab": "Disable tab",
    "settings.wg.title": "Tab “Tools”",
    "settings.wg.disable.hint": "Hides the Tools tab and disables its startup flow. Related options become unavailable while it is disabled.",
    "settings.wg.autosend": "Auto-send on app startup",
    "settings.wg.rememberLastTool": "Remember last opened tool",
    "settings.wg.rememberLastTool.hint": "When enabled, the Tools tab reopens with the tool you used last time.",
    "settings.wg.autoclose.hint": "Automatically closes the app after the selected delay.",
