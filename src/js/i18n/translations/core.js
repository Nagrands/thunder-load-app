export const coreTranslations = {
  "ru": {
    ...
    "input.url.helper.valid": "Ссылка распознана. Выберите режим ниже или нажмите Enter для обычной загрузки.",
    "input.url.helper.playlistChoice": "Это плейлист. Можно скачать текущий ролик или добавить весь плейлист в очередь.",
  ...
  "en": {
    ...
    "input.url.helper.valid": "Link recognized. Pick a mode below or press Enter for the default download.",
    "input.url.helper.playlistChoice": "This is a playlist. You can download the current item or add the whole playlist to the queue.",
