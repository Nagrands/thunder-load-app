export const coreTranslations = {
  ru: {
    ...
    "nowPlaying.empty.title": "Медиатека пуста",
    "nowPlaying.empty.hint":
      "Добавьте аудио, видео, папку или ссылку на YouTube.",
  ...
  en: {
    ...
    "nowPlaying.empty.title": "Your media library is empty",
    "nowPlaying.empty.hint": "Add audio, video, a folder, or a YouTube link.",
