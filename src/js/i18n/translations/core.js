export const coreTranslations = {
  "ru": {
    ...
    "input.url.helper.valid": "Ссылка распознана. Enter скачает, Shift+Enter добавит в очередь, Alt+Enter включит режим только аудио.",
  ...
  "en": {
    ...
    "input.url.helper.valid": "Link recognized. Enter downloads it, Shift+Enter queues it, and Alt+Enter switches to audio only.",
