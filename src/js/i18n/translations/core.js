export const coreTranslations = {
  ru: {
    ...
    "nowPlaying.importing": "Добавляем музыку…",
    "nowPlaying.error": "Не удалось выполнить операцию.",
    "nowPlaying.unknownArtist": "Неизвестный исполнитель",
    "nowPlaying.empty.title": "Локальная библиотека пуста",
    "nowPlaying.empty.hint":
      "Добавьте аудио, видео или папку с музыкальными файлами.",
  ...
  en: {
    ...
    "nowPlaying.importing": "Adding music…",
    "nowPlaying.error": "The operation could not be completed.",
    "nowPlaying.unknownArtist": "Unknown artist",
    "nowPlaying.empty.title": "Your local library is empty",
    "nowPlaying.empty.hint":
      "Add audio, video, or a folder containing music files.",
