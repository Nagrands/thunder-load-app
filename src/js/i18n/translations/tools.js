export const toolsTranslations = {
  ru: {
    ...
    "tools.winget.subtitle":
      "Соберите PowerShell-скрипт из выбранных пакетов, проверьте его и запустите установку в Windows.",
    ...
    "tools.winget.category.archives": "Архиваторы",
    ...
    "tools.winget.package.7zip.desc": "Архиватор для ZIP, 7z и RAR.",
    "tools.winget.package.firefox.desc":
      "Браузер Mozilla с расширениями и синхронизацией.",
    "tools.winget.package.git.desc": "Система контроля версий для разработки.",
    "tools.winget.package.chrome.desc": "Браузер Google Chrome.",
    "tools.winget.package.klite.desc":
      "Набор кодеков для воспроизведения видео и аудио.",
    "tools.winget.package.afterburner.desc":
      "Мониторинг и настройка видеокарты, плюс RTSS overlay.",
    "tools.winget.package.node.desc":
      "Node.js LTS для JavaScript-инструментов.",
    "tools.winget.package.obs.desc":
      "Запись экрана и стриминг через OBS Studio.",
    "tools.winget.package.obsidian.desc":
      "Markdown-заметки и личная база знаний.",
    "tools.winget.package.opera.desc": "Браузер Opera.",
    "tools.winget.package.powershell.desc":
      "Современная оболочка PowerShell 7.",
    "tools.winget.package.powertoys.desc":
      "Набор утилит Microsoft PowerToys для Windows.",
    "tools.winget.package.python.desc":
      "Python 3.14 для разработки и скриптов.",
    "tools.winget.package.qbittorrent.desc": "BitTorrent-клиент без рекламы.",
    "tools.winget.package.steam.desc": "Клиент магазина и библиотеки Steam.",
    "tools.winget.package.vlc.desc": "Медиаплеер VLC для большинства форматов.",
    "tools.winget.package.raycast.desc": "Лаунчер и быстрые команды Raycast.",
    "tools.winget.package.vscode.desc": "Редактор кода Visual Studio Code.",
    "tools.winget.package.terminal.desc":
      "Современный терминал Windows Terminal.",
    "tools.winget.package.wireguard.desc": "VPN-клиент WireGuard для Windows.",
    ...
    "tools.winget.script.title": "PowerShell script",
    ...
    "tools.winget.log.title": "Live-log PowerShell",
  ...
  en: {
    ...
    "tools.winget.title": "WinGet Installer",
    "tools.winget.subtitle":
      "Build a PowerShell script from selected packages, review it, and run installation on Windows.",
    ...
    "tools.winget.category.archives": "Archivers",
    "tools.winget.category.develop": "Develop",
    ...
    "tools.winget.package.7zip.desc": "Archiver for ZIP, 7z, and RAR files.",
    "tools.winget.package.firefox.desc":
      "Mozilla browser with extensions and sync.",
    "tools.winget.package.git.desc": "Version control system for development.",
    "tools.winget.package.chrome.desc": "Google Chrome browser.",
    "tools.winget.package.klite.desc":
      "Codec pack for video and audio playback.",
    "tools.winget.package.afterburner.desc":
      "GPU monitoring and tuning, plus RTSS overlay.",
    "tools.winget.package.node.desc": "Node.js LTS for JavaScript tooling.",
    "tools.winget.package.obs.desc":
      "Screen recording and streaming with OBS Studio.",
    "tools.winget.package.obsidian.desc":
      "Markdown notes and personal knowledge base.",
    "tools.winget.package.opera.desc": "Opera browser.",
    "tools.winget.package.powershell.desc": "Modern PowerShell 7 shell.",
    "tools.winget.package.powertoys.desc":
      "Microsoft PowerToys utilities for Windows.",
    "tools.winget.package.python.desc":
      "Python 3.14 for development and scripts.",
    "tools.winget.package.qbittorrent.desc": "Ad-free BitTorrent client.",
    "tools.winget.package.steam.desc": "Steam store and library client.",
    "tools.winget.package.vlc.desc": "VLC media player for most media formats.",
    "tools.winget.package.raycast.desc": "Raycast launcher and quick commands.",
    "tools.winget.package.vscode.desc": "Visual Studio Code editor.",
    "tools.winget.package.terminal.desc": "Modern Windows Terminal.",
    "tools.winget.package.wireguard.desc": "WireGuard VPN client for Windows.",
    ...
    "tools.winget.log.title": "PowerShell live log",
