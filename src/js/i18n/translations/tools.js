export const toolsTranslations = {
  ru: {
    ...
    "tools.winget.subtitle":
      "Соберите Script из выбранных пакетов, проверьте его и запустите действие в Windows.",
    ...
    "tools.winget.script.step.action":
      "Затем выполняется install, update или uninstall для нужных ID.",
    ...
    "tools.winget.log.title": "PowerShell Лог",
