export const toolsTranslations = {
  ru: {
    ...
    "tools.sidebar.aria": "Навигация по инструментам",
    "tools.sidebar.description":
    ...
    "tools.dependencies.installedTitle": "Установленные инструменты",
    "tools.button.checkTooltip":
      "Проверить доступные обновления для инструментов",
    ...
    "tools.summary.lastChecked": "Последняя проверка",
    "tools.summary.neverChecked": "Инструменты ещё не проверялись",
    "tools.summary.notChecked": "Не проверено",
    "tools.summary.notCheckedTitle": "Инструменты не проверялись",
    "tools.summary.notCheckedDescription":
      "Запустите проверку, чтобы получить актуальное состояние",
    "tools.summary.checkingTitle": "Проверяем инструменты",
    "tools.summary.checkingDescription":
      "Получаем фактические версии и состояние файлов",
    "tools.summary.readyDescription":
      "Установленные инструменты работают корректно",
    "tools.summary.updatesTitle": "Доступны обновления",
    "tools.summary.updatesDescription":
      "Один или несколько инструментов можно обновить",
    "tools.summary.missingTitle": "Требуется установка",
    "tools.summary.missingDescription":
      "Один или несколько обязательных инструментов отсутствуют",
    "tools.summary.errorTitle": "Не удалось проверить инструменты",
    "tools.summary.errorDescription":
      "Проверьте отдельные строки и повторите операцию",
    "tools.summary.offlineTitle": "Нет подключения к сети",
    "tools.summary.offlineDescription":
      "Локальные версии доступны, но проверка обновлений невозможна",
    "tools.hint.missing":
    ...
    "tools.location.openShort": "Открыть",
    "tools.location.copy": "Копировать путь",
    "tools.location.reveal.generic": "Показать в файловом менеджере",
    "tools.location.reveal.darwin": "Показать в Finder",
    "tools.location.reveal.win32": "Показать в Проводнике",
    "tools.location.reveal.linux": "Показать в файловом менеджере",
    "tools.location.unavailable": "Путь недоступен",
    "tools.location.unavailableDescription":
      "Не удалось получить папку инструментов. Выберите или восстановите каталог.",
    "tools.location.revealError": "Не удалось показать папку инструментов",
    "tools.location.copyError": "Не удалось скопировать путь",
    ...
    "tools.version.current": "Версия: {version}",
    "tools.version.unavailable": "Версия недоступна",
    "tools.version.copied": "Версия скопирована",
    "tools.toolStatus.installed": "Установлено",
    "tools.toolStatus.updateAvailable": "Доступно обновление",
    "tools.toolStatus.missing": "Не установлено",
    "tools.toolStatus.checking": "Проверка…",
    "tools.toolStatus.updating": "Обновление…",
    "tools.toolStatus.error": "Ошибка",
    "tools.toolStatus.unknownVersion": "Версия неизвестна",
    "tools.toolStatus.notChecked": "Не проверено",
    "tools.toolStatus.errorHint":
      "Операция завершилась ошибкой. Повторите проверку.",
    "tools.menu.open": "Открыть меню инструмента",
    "tools.menu.check": "Проверить обновление",
    "tools.menu.install": "Установить",
    "tools.menu.update": "Обновить",
    "tools.menu.reinstall": "Переустановить",
    "tools.menu.reveal": "Открыть расположение",
    "tools.menu.copyVersion": "Копировать версию",
    "tools.advanced.toggle": "Показать дополнительные параметры",
    "tools.advanced.description":
      "Дополнительные параметры и настройки инструментов",
    "tools.action.success": "{tool}: операция завершена",
    "tools.action.error": "{tool}: не удалось выполнить операцию",
    ...
    "tools.confirm.single.title": "Переустановить {tool}?",
    "tools.confirm.single.message":
      "Текущий файл {tool} будет безопасно заменён новой копией.",
  ...
  en: {
    ...
    "tools.title": "Tools",
    "tools.sidebar.aria": "Tools navigation",
    ...
    "tools.dependencies.installedTitle": "Installed tools",
    "tools.button.checkTooltip": "Check tools for available updates",
    ...
    "tools.summary.lastChecked": "Last checked",
    "tools.summary.neverChecked": "Tools have not been checked yet",
    "tools.summary.notChecked": "Not checked",
    "tools.summary.notCheckedTitle": "Tools have not been checked",
    "tools.summary.notCheckedDescription":
      "Run a check to get the current status",
    "tools.summary.checkingTitle": "Checking tools",
    "tools.summary.checkingDescription":
      "Reading actual versions and file availability",
    "tools.summary.readyDescription": "Installed tools are working correctly",
    "tools.summary.updatesTitle": "Updates are available",
    "tools.summary.updatesDescription":
      "One or more tools can be updated",
    "tools.summary.missingTitle": "Installation required",
    "tools.summary.missingDescription":
      "One or more required tools are missing",
    "tools.summary.errorTitle": "Tools check failed",
    "tools.summary.errorDescription":
      "Review the affected rows and try again",
    "tools.summary.offlineTitle": "No network connection",
    "tools.summary.offlineDescription":
      "Local versions are available, but update checks are unavailable",
    "tools.hint.missing":
    ...
    "tools.location.openShort": "Open",
    "tools.location.copy": "Copy path",
    "tools.location.reveal.generic": "Show in file manager",
    "tools.location.reveal.darwin": "Show in Finder",
    "tools.location.reveal.win32": "Show in File Explorer",
    "tools.location.reveal.linux": "Show in file manager",
    "tools.location.unavailable": "Path unavailable",
    "tools.location.unavailableDescription":
      "Could not get the tools folder. Choose or restore the directory.",
    "tools.location.revealError": "Could not reveal the tools folder",
    "tools.location.copyError": "Could not copy the path",
    ...
    "tools.version.current": "Version: {version}",
    "tools.version.unavailable": "Version unavailable",
    "tools.version.copied": "Version copied",
    "tools.toolStatus.installed": "Installed",
    "tools.toolStatus.updateAvailable": "Update available",
    "tools.toolStatus.missing": "Not installed",
    "tools.toolStatus.checking": "Checking…",
    "tools.toolStatus.updating": "Updating…",
    "tools.toolStatus.error": "Error",
    "tools.toolStatus.unknownVersion": "Unknown version",
    "tools.toolStatus.notChecked": "Not checked",
    "tools.toolStatus.errorHint": "The operation failed. Try checking again.",
    "tools.menu.open": "Open tool menu",
    "tools.menu.check": "Check for update",
    "tools.menu.install": "Install",
    "tools.menu.update": "Update",
    "tools.menu.reinstall": "Reinstall",
    "tools.menu.reveal": "Open location",
    "tools.menu.copyVersion": "Copy version",
    "tools.advanced.toggle": "Show advanced options",
    "tools.advanced.description": "Additional tool options and settings",
    "tools.action.success": "{tool}: operation completed",
    "tools.action.error": "{tool}: operation failed",
    ...
    "tools.confirm.single.title": "Reinstall {tool}?",
    "tools.confirm.single.message":
      "The current {tool} file will be safely replaced with a new copy.",
