export const toolsTranslations = {
  ru: {
    ...
    "productsFormatter.dictionaryPlaceholder":
      "Каждая строка: исходное = замена\nИли: alias: исходное = замена\nnormalize: шум = канон\ntokens: лук + репчат !зел = Лук репчатый",
    ...
    "productsFormatter.dictionaryCategoryAlias": "Alias",
    "productsFormatter.dictionaryCategoryNormalize": "Normalize",
    "productsFormatter.dictionaryCategoryToken": "Token rules",
    "productsFormatter.dictionarySuggestionLabel": "Подсказка",
    ...
    "tools.launcher.badges.aria": "Версия и статус инструмента",
    "tools.launcher.badge.new": "Новый",
    ...
    "tools.launcher.open.mediaConverter": "Конвертер форматов",
    ...
    "tools.launcher.desc.mediaConverter":
      "Конвертация локальных аудио и видео через ffmpeg.",
    ...
    "tools.nav.current.mediaConverter": "Конвертер форматов",
    "tools.nav.current.power": "Быстрые ярлыки",
    "tools.nav.current.backup": "Backup",
    "tools.nav.current.sorter": "Сортировщик",
    "tools.nav.current.wingetInstaller": "WinGet Installer",
    "tools.winget.title": "WinGet Installer",
    "tools.winget.subtitle":
      "Соберите сценарий из выбранных пакетов, проверьте его и запустите действие в Windows.",
    "tools.winget.platform.title": "Ограничение платформы",
    "tools.winget.platform.body":
      "Запуск PowerShell и проверка WinGet доступны только в Windows. Здесь можно настроить список и скопировать скрипт.",
    "tools.winget.platform.ready": "Готов",
    "tools.winget.platform.running": "Выполняется",
    "tools.winget.platform.checking": "Проверка",
    "tools.winget.platform.preview": "Предпросмотр",
    "tools.winget.packages.title": "Пакеты",
    "tools.winget.selectAll": "Выбрать всё",
    "tools.winget.clearSelection": "Очистить",
    "tools.winget.category.browsers": "Браузеры",
    "tools.winget.category.media": "Медиа",
    "tools.winget.category.develop": "Разработка",
    ...
    "tools.winget.package.7zip.desc": "Архивы ZIP, 7z и RAR.",
    "tools.winget.package.firefox.desc": "",
    "tools.winget.package.git.desc": "Система контроля версий для разработки.",
    "tools.winget.package.chrome.desc": "",
    "tools.winget.package.klite.desc": "Кодеки для видео и аудио.",
    "tools.winget.package.afterburner.desc":
      "Мониторинг GPU и RTSS в составе установщика.",
    "tools.winget.package.node.desc": "Node.js LTS.",
    "tools.winget.package.obs.desc": "Запись экрана и стриминг.",
    "tools.winget.package.obsidian.desc": "Markdown-заметки.",
    "tools.winget.package.opera.desc": "",
    "tools.winget.package.powershell.desc":
      "Современная оболочка PowerShell 7.",
    "tools.winget.package.powertoys.desc": "Утилиты Microsoft PowerToys.",
    "tools.winget.package.python.desc": "Python 3.14.",
    "tools.winget.package.qbittorrent.desc": "BitTorrent-клиент без рекламы.",
    "tools.winget.package.steam.desc": "Игры и библиотека Steam.",
    "tools.winget.package.vlc.desc": "Медиаплеер VLC.",
    "tools.winget.package.raycast.desc": "Лаунчер быстрых команд.",
    "tools.winget.package.vscode.desc": "Редактор кода.",
    "tools.winget.package.terminal.desc": "Современный терминал.",
    "tools.winget.package.wireguard.desc": "VPN-клиент WireGuard.",
    "tools.winget.custom.label": "Свои WinGet ID",
    "tools.winget.custom.placeholder":
      "Например:\nNotepad++.Notepad++\nMicrosoft.Sysinternals.ProcessExplorer",
    "tools.winget.custom.hint":
      "Можно вводить по одному ID в строке или через запятую.",
    "tools.winget.custom.invalid": "Некорректные ID: {ids}",
    "tools.winget.script.title": "Сценарий",
    "tools.winget.script.subtitle":
      "Проверьте команды перед запуском. В приложение отправляются только WinGet ID, не произвольный код.",
    "tools.winget.script.empty": "Выберите хотя бы один пакет.",
    "tools.winget.script.preflight": "Проверка winget --version",
    "tools.winget.script.actionLabel": "Режим: {mode}",
    "tools.winget.script.step.preflight": "Сначала проверяется версия WinGet.",
    "tools.winget.script.step.action":
      "Затем выполняется установка, обновление или удаление для нужных ID.",
    "tools.winget.script.step.result":
      "Ошибки пакетов собираются и возвращают ненулевой exit code.",
    "tools.winget.selectedCount": "Пакетов: {count}",
    "tools.winget.copyScript": "Копировать скрипт",
    "tools.winget.mode.aria": "Режим скрипта",
    "tools.winget.mode.install": "Установка",
    "tools.winget.mode.upgrade": "Обновление",
    "tools.winget.mode.uninstall": "Удаление",
    "tools.winget.checkStatus": "Проверить статус",
    "tools.winget.run": "Запустить",
    "tools.winget.cancel": "Остановить",
    "tools.winget.status.title": "Статус приложений",
    "tools.winget.status.empty": "Статус пока не проверялся.",
    "tools.winget.status.package": "ID пакета",
    ...
    "tools.winget.status.checking": "Проверяется",
    "tools.winget.status.installing": "Устанавливается",
    ...
    "tools.winget.version.empty": "Версия не определена",
    "tools.winget.version.current": "Версия: {version}",
    "tools.winget.version.latest": "Доступно: {version}",
    "tools.winget.log.title": "Лог PowerShell",
    "tools.winget.log.placeholder": "Лог PowerShell появится здесь.",
    "tools.winget.copyFullLog": "Копировать весь лог",
    "tools.winget.copyOperationLog": "Копировать последнюю операцию",
    "tools.winget.log.statusStart": "Проверяем статусы WinGet...",
    "tools.winget.log.statusDone": "Проверка статусов завершена.",
    "tools.winget.log.statusError": "Не удалось проверить статусы.",
    "tools.winget.log.runStart": "Запуск режима: {mode}",
    "tools.winget.log.runDone": "PowerShell завершил выполнение.",
    "tools.winget.log.runError": "PowerShell завершился с ошибкой.",
    "tools.winget.log.cancelled": "Запуск остановлен пользователем.",
    "tools.winget.toast.copied": "Скрипт скопирован.",
    "tools.winget.toast.logCopied": "Лог скопирован.",
    "tools.winget.toast.copyError": "Не удалось скопировать скрипт.",
    "tools.converter.title": "Конвертер форматов",
    "tools.converter.subtitle":
      "Конвертирует один локальный аудио или видеофайл через ffmpeg.",
    "tools.converter.source.title": "Исходный файл",
    "tools.converter.settings.title": "Параметры",
    "tools.converter.output.title": "Папка результата",
    "tools.converter.pickFile": "Выбрать файл",
    "tools.converter.pickFolder": "Выбрать папку",
    "tools.converter.noFile": "Файл не выбран",
    "tools.converter.dropHint":
      "Перетащите медиафайл сюда или выберите его вручную.",
    "tools.converter.format": "Формат",
    "tools.converter.quality": "Качество",
    "tools.converter.group.video": "Видео",
    "tools.converter.group.audio": "Аудио",
    "tools.converter.quality.balanced": "Баланс",
    "tools.converter.quality.balanced.hint": "Оптимальный размер и качество.",
    "tools.converter.quality.small": "Меньше",
    "tools.converter.quality.small.hint": "Сжимает сильнее.",
    "tools.converter.quality.high": "Выше",
    "tools.converter.quality.high.hint": "Сохраняет больше деталей.",
    "tools.converter.output.auto": "Автоматически: рядом с исходным файлом",
    "tools.converter.convert": "Конвертировать",
    "tools.converter.cancel": "Отменить",
    "tools.converter.openResult": "Открыть результат",
    "tools.converter.progress.idle": "Ожидание",
    "tools.converter.progress.running": "Конвертация...",
    "tools.converter.progress.done": "Готово",
    "tools.converter.status.idle": "Выберите файл и параметры.",
    "tools.converter.status.ready": "Файл готов к конвертации.",
    "tools.converter.status.running": "Конвертация выполняется.",
    "tools.converter.status.done": "Готово: {fileName}",
    "tools.converter.status.cancelled": "Конвертация отменена.",
    ...
    "hashCheck.progress.idle": "Прогресс появится во время проверки.",
    "hashCheck.progress.file": "Вычисление: {fileName}",
    "hashCheck.history.title": "Последние проверки",
    "hashCheck.history.hint":
      "Недавние файлы и результаты можно быстро вернуть в форму.",
    "hashCheck.history.empty": "История появится после первой проверки.",
    "hashCheck.history.clear": "Очистить",
    "hashCheck.history.restore": "Вернуть проверку",
    "hashCheck.history.copy": "Копировать хеш",
    "hashCheck.history.expected": "Ожидаемый хеш",
    "hashCheck.history.compare": "Сравнение файлов",
    "hashCheck.history.calculated": "Вычислено",
    "hashCheck.history.match": "Совпадение",
    "hashCheck.history.mismatch": "Не совпало",
  ...
  en: {
    ...
    "productsFormatter.dictionaryPlaceholder":
      "One rule per line: source = replacement\nOr: alias: source = replacement\nnormalize: noisy = canonical\ntokens: onion + bulb !green = Bulb onion",
    "productsFormatter.dictionaryHint":
    ...
    "productsFormatter.dictionaryCategoryNormalize": "Normalize",
    "productsFormatter.dictionaryCategoryToken": "Token rules",
    "productsFormatter.dictionarySuggestionLabel": "Suggestion",
    "productsFormatter.dictionaryRuleType.alias": "alias",
    "productsFormatter.dictionaryRuleType.normalize": "normalize",
    "productsFormatter.dictionaryRuleType.token_rule": "token rule",
    ...
    "tools.launcher.badges.aria": "Tool version and status",
    "tools.launcher.badge.new": "New",
    "tools.launcher.open.wg": "WG Unlock",
    "tools.launcher.open.hash": "Hash Check",
    "tools.launcher.open.power": "Shortcuts",
    "tools.launcher.open.backup": "Backup",
    "tools.launcher.open.mediaInspector": "Media Inspector",
    "tools.launcher.open.mediaConverter": "Format Converter",
    ...
    "tools.launcher.desc.mediaConverter":
      "Convert local audio and video files through ffmpeg.",
    "tools.launcher.desc.downloaderTools":
    ...
    "tools.nav.current.mediaInspector": "Media Inspector",
    "tools.nav.current.mediaConverter": "Format Converter",
    ...
    "tools.winget.title": "WinGet Installer",
    "tools.winget.subtitle":
      "Build a Script from selected packages, review it, and run the action on Windows.",
    "tools.winget.platform.title": "Platform limit",
    "tools.winget.platform.body":
      "PowerShell execution and WinGet status checks are available only on Windows. You can still configure the list and copy the script here.",
    "tools.winget.platform.ready": "Ready",
    "tools.winget.platform.running": "Running",
    "tools.winget.platform.checking": "Checking",
    "tools.winget.platform.preview": "Preview",
    "tools.winget.packages.title": "Packages",
    "tools.winget.selectAll": "Select all",
    "tools.winget.clearSelection": "Clear",
    "tools.winget.category.browsers": "Browsers",
    "tools.winget.category.media": "Media",
    "tools.winget.category.develop": "Develop",
    "tools.winget.category.system": "System",
    "tools.winget.category.productivity": "Productivity",
    "tools.winget.category.network": "Network",
    "tools.winget.category.games": "Games",
    "tools.winget.package.7zip.desc": "ZIP, 7z, and RAR archives.",
    "tools.winget.package.firefox.desc": "",
    "tools.winget.package.git.desc": "Version control system for development.",
    "tools.winget.package.chrome.desc": "",
    "tools.winget.package.klite.desc": "Video and audio codecs.",
    "tools.winget.package.afterburner.desc":
      "GPU monitoring with bundled RTSS.",
    "tools.winget.package.node.desc": "Node.js LTS.",
    "tools.winget.package.obs.desc": "Recording and streaming.",
    "tools.winget.package.obsidian.desc": "Markdown notes.",
    "tools.winget.package.opera.desc": "",
    "tools.winget.package.powershell.desc": "Modern PowerShell 7 shell.",
    "tools.winget.package.powertoys.desc": "Microsoft PowerToys utilities.",
    "tools.winget.package.python.desc": "Python 3.14.",
    "tools.winget.package.qbittorrent.desc": "Ad-free BitTorrent client.",
    "tools.winget.package.steam.desc": "Steam games and library.",
    "tools.winget.package.vlc.desc": "VLC media player.",
    "tools.winget.package.raycast.desc": "Quick command launcher.",
    "tools.winget.package.vscode.desc": "Code editor.",
    "tools.winget.package.terminal.desc": "Modern terminal.",
    "tools.winget.package.wireguard.desc": "WireGuard VPN client.",
    "tools.winget.custom.label": "Custom WinGet IDs",
    "tools.winget.custom.placeholder":
      "For example:\nNotepad++.Notepad++\nMicrosoft.Sysinternals.ProcessExplorer",
    "tools.winget.custom.hint":
      "Enter one ID per line or separate IDs with commas.",
    "tools.winget.custom.invalid": "Invalid IDs: {ids}",
    "tools.winget.script.title": "Script",
    "tools.winget.script.subtitle":
      "Review commands before running. The app sends only WinGet IDs, not arbitrary code.",
    "tools.winget.script.empty": "Select at least one package.",
    "tools.winget.script.preflight": "Checks winget --version",
    "tools.winget.script.actionLabel": "Mode: {mode}",
    "tools.winget.script.step.preflight": "WinGet version is checked first.",
    "tools.winget.script.step.action":
      "Then install, update, or uninstall runs for the relevant IDs.",
    "tools.winget.script.step.result":
      "Package failures are collected and return a non-zero exit code.",
    "tools.winget.selectedCount": "Packages: {count}",
    "tools.winget.copyScript": "Copy script",
    "tools.winget.mode.aria": "Script mode",
    "tools.winget.mode.install": "Install",
    "tools.winget.mode.upgrade": "Update",
    "tools.winget.mode.uninstall": "Uninstall",
    "tools.winget.checkStatus": "Check status",
    "tools.winget.run": "Run",
    "tools.winget.cancel": "Stop",
    "tools.winget.status.title": "Application status",
    "tools.winget.status.empty": "Status has not been checked yet.",
    "tools.winget.status.package": "Package ID",
    "tools.winget.status.state": "State",
    "tools.winget.status.current": "Current version",
    "tools.winget.status.latest": "Update",
    "tools.winget.status.installed": "Installed",
    "tools.winget.status.notInstalled": "Not installed",
    "tools.winget.status.updateAvailable": "Update available",
    "tools.winget.status.partial": "Partially installed",
    "tools.winget.status.checking": "Checking",
    "tools.winget.status.installing": "Installing",
    ...
    "tools.winget.version.empty": "Version unknown",
    "tools.winget.version.current": "Version: {version}",
    "tools.winget.version.latest": "Available: {version}",
    "tools.winget.log.title": "PowerShell Log",
    "tools.winget.log.placeholder": "PowerShell log will appear here.",
    "tools.winget.copyFullLog": "Copy full log",
    "tools.winget.copyOperationLog": "Copy last operation",
    "tools.winget.log.statusStart": "Checking WinGet statuses...",
    "tools.winget.log.statusDone": "Status check complete.",
    "tools.winget.log.statusError": "Could not check statuses.",
    "tools.winget.log.runStart": "Starting mode: {mode}",
    "tools.winget.log.runDone": "PowerShell finished.",
    "tools.winget.log.runError": "PowerShell finished with an error.",
    "tools.winget.log.cancelled": "Run stopped by user.",
    "tools.winget.toast.copied": "Script copied.",
    "tools.winget.toast.logCopied": "Log copied.",
    "tools.winget.toast.copyError": "Could not copy script.",
    "tools.converter.title": "Format Converter",
    "tools.converter.subtitle":
      "Convert one local audio or video file with ffmpeg.",
    "tools.converter.source.title": "Source file",
    "tools.converter.settings.title": "Settings",
    "tools.converter.output.title": "Output folder",
    ...
    "tools.converter.group.audio": "Audio",
    "tools.converter.quality.balanced": "Balanced",
    "tools.converter.quality.balanced.hint": "Good size and quality.",
    "tools.converter.quality.small": "Smaller",
    "tools.converter.quality.small.hint": "Compresses more aggressively.",
    "tools.converter.quality.high": "Higher",
    "tools.converter.quality.high.hint": "Keeps more detail.",
    "tools.converter.output.auto": "Automatic: next to the source file",
    "tools.converter.convert": "Convert",
    "tools.converter.cancel": "Cancel",
    "tools.converter.openResult": "Open result",
    "tools.converter.progress.idle": "Idle",
    "tools.converter.progress.running": "Converting...",
    "tools.converter.progress.done": "Done",
    "tools.converter.status.idle": "Choose a file and settings.",
    "tools.converter.status.ready": "File is ready to convert.",
    "tools.converter.status.running": "Conversion is running.",
    "tools.converter.status.done": "Done: {fileName}",
    "tools.converter.status.cancelled": "Conversion cancelled.",
    ...
    "hashCheck.progress.idle": "Progress appears during verification.",
    "hashCheck.progress.file": "Calculating: {fileName}",
    "hashCheck.history.title": "Recent checks",
    "hashCheck.history.hint":
      "Recent files and results can be restored back into the form.",
    "hashCheck.history.empty": "History appears after the first verification.",
    "hashCheck.history.clear": "Clear",
    "hashCheck.history.restore": "Restore check",
    "hashCheck.history.copy": "Copy hash",
    "hashCheck.history.expected": "Expected hash",
    "hashCheck.history.compare": "File comparison",
    "hashCheck.history.calculated": "Calculated",
    "hashCheck.history.match": "Matched",
    "hashCheck.history.mismatch": "Mismatch",
