...
const CHANNELS = Object.freeze({
  ...
  DIAGNOSTICS_GET_LEVEL: "diagnostics:get-level",
  DIAGNOSTICS_SET_LEVEL: "diagnostics:set-level",
  ...
  NOW_PLAYING_IMPORT_PATHS: "now-playing:import-paths",
  NOW_PLAYING_IMPORT_YOUTUBE_VIDEO: "now-playing:import-youtube-video",
  NOW_PLAYING_ANALYZE_YOUTUBE_VIDEO: "now-playing:analyze-youtube-video",
  ...
  NOW_PLAYING_OPEN_FILES_READY: "now-playing:open-files-ready",
  NOW_PLAYING_MEDIA_STATE: "now-playing:media-state",
  NOW_PLAYING_MEDIA_COMMAND: "now-playing:media-command",
  ...
  WINDOWS_TRAY_MENU_GET_STATE: "windows-tray-menu:get-state",
  WINDOWS_TRAY_MENU_ACTION: "windows-tray-menu:action",
  WINDOWS_TRAY_MENU_CLOSE: "windows-tray-menu:close",
