...
const CHANNELS = Object.freeze({
  ...
  GET_DOWNLOAD_PARALLEL_LIMIT: "get-download-parallel-limit",
  GET_DOWNLOAD_PATH: "get-download-path",
  GET_YTDLP_COOKIES_SETTINGS: "get-ytdlp-cookies-settings",
  ...
  WEB_SET_ENABLED: "web:setEnabled",
  ...
  SELECT_YTDLP_COOKIES_FILE: "select-ytdlp-cookies-file",
  ...
  SET_DOWNLOAD_PARALLEL_LIMIT: "set-download-parallel-limit",
  SET_YTDLP_COOKIES_SETTINGS: "set-ytdlp-cookies-settings",
  ...
  SHORTCUTS_REPLACE: "shortcuts:replace",
  ...
  TOOLS_HASH_PROGRESS: "tools:hashProgress",
  TOOLS_MEDIA_INSPECTOR_PICK_FILE: "tools:mediaInspectorPickFile",
  TOOLS_MEDIA_INSPECTOR_ANALYZE: "tools:mediaInspectorAnalyze",
  TOOLS_CONVERTER_PICK_FILE: "tools:converterPickFile",
  TOOLS_CONVERTER_PICK_FOLDER: "tools:converterPickFolder",
  TOOLS_CONVERTER_CONVERT: "tools:converterConvert",
  TOOLS_CONVERTER_CANCEL: "tools:converterCancel",
  TOOLS_CONVERTER_PROGRESS: "tools:converterProgress",
  TOOLS_SORTER_PICK_FOLDER: "tools:sorterPickFolder",
  TOOLS_SORTER_OPEN_FOLDER: "tools:sorterOpenFolder",
  TOOLS_SORTER_PREVIEW_PLAN: "tools:previewSorterPlan",
  TOOLS_SORTER_APPLY_PLAN: "tools:applySorterPlan",
  TOOLS_SORTER_UNDO_RUN: "tools:undoSorterRun",
