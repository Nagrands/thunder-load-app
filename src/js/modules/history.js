...
document
  ...
  ?.addEventListener("click", async () => {
    ...
    console.log("📥 setHistoryData выполнен. Актуальная история:", getHistoryData());
    ...
    filterAndSortHistory(state.currentSearchQuery, state.currentSortOrder, true); // ✅ перерисовываем (без loadHistory)
...
function renderHistory(entries) {
  ...
  console.log("🧾 renderHistory получил entries:", entries.map(e => e.id));
